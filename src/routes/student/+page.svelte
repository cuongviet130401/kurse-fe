    ...
    <section id="main-content" class="w-full">
      <div id="active-courses" style="margin-bottom: 2rem;" class="w-full">
        <div id="recent-course-navigation" style="margin-bottom: 2rem;">
          ...
          {:then recentCourse}
            <aside
              class="alert variant-soft-primary !p-0 overflow-x-hidden outline shadow-2xl"
            >
              <div
                class=""
                style="margin-left: -1.5rem; max-width: 20%; max-height: 100%;"
              >
                <img
                  src={recentCourse.imgUrl}
                  alt=""
                  class="w-full h-full rounded-e-full"
                  style="min-width: 20%;"
                />
              </div>
              <div
                class="alert-message flex flex-col justify-between !h-full min-h-full gap-8"
              >
                <div>
                ...
                <ProgressBar
                  value={recentCourse.progressPercent}
                  max={100}
              ...
              <div class="alert-action" style="margin-right: 1rem;">
                <a
                  href={recentCourse.navigationUrl}
                  class="btn variant-filled cursor-pointer text-xl"
                >
